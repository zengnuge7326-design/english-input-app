...
export default function GamePage({ onStartDefender, onStartFrog, crystalBalance = 0, onCrystalSpend }: Props) {
  ...
  function renderCard(game: GameId) {
    ...
    const start = game === 'defender' ? onStartDefender : onStartFrog
    return (
