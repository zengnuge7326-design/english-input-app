/** 26 英文字母：大小写、字母名、儿童具象例词、读音、卡通配色、SVG 图标键 */
export const ALPHABET_LETTERS = [
  { upper: 'A', lower: 'a', name: 'A', example: 'apple',      zh: '苹果',   sound: '/æ/',  color: 'rose',    icon: 'apple' },
  { upper: 'B', lower: 'b', name: 'B', example: 'ball',       zh: '球',     sound: '/b/',  color: 'blue',    icon: 'ball' },
  { upper: 'C', lower: 'c', name: 'C', example: 'cat',        zh: '猫',     sound: '/k/',  color: 'orange',  icon: 'cat' },
  { upper: 'D', lower: 'd', name: 'D', example: 'dog',        zh: '狗',     sound: '/d/',  color: 'amber',   icon: 'dog' },
  { upper: 'E', lower: 'e', name: 'E', example: 'egg',        zh: '鸡蛋',   sound: '/i:/', color: 'yellow',  icon: 'egg' },
  { upper: 'F', lower: 'f', name: 'F', example: 'fish',       zh: '鱼',     sound: '/f/',  color: 'cyan',    icon: 'fish' },
  { upper: 'G', lower: 'g', name: 'G', example: 'grape',      zh: '葡萄',   sound: '/ɡ/',  color: 'purple',  icon: 'grape' },
  { upper: 'H', lower: 'h', name: 'H', example: 'hat',        zh: '帽子',   sound: '/h/',  color: 'teal',    icon: 'hat' },
  { upper: 'I', lower: 'i', name: 'I', example: 'ice cream',  zh: '冰淇淋', sound: '/aɪ/', color: 'sky',     icon: 'icecream' },
  { upper: 'J', lower: 'j', name: 'J', example: 'jam',        zh: '果酱',   sound: '/dʒ/', color: 'pink',    icon: 'jam' },
  { upper: 'K', lower: 'k', name: 'K', example: 'key',        zh: '钥匙',   sound: '/k/',  color: 'amber',   icon: 'key' },
  { upper: 'L', lower: 'l', name: 'L', example: 'lion',       zh: '狮子',   sound: '/l/',  color: 'orange',  icon: 'lion' },
  { upper: 'M', lower: 'm', name: 'M', example: 'moon',       zh: '月亮',   sound: '/m/',  color: 'indigo',  icon: 'moon' },
  { upper: 'N', lower: 'n', name: 'N', example: 'nest',       zh: '鸟巢',   sound: '/n/',  color: 'lime',    icon: 'nest' },
  { upper: 'O', lower: 'o', name: 'O', example: 'orange',     zh: '橙子',   sound: '/ɒ/',  color: 'orange',  icon: 'orange' },
  { upper: 'P', lower: 'p', name: 'P', example: 'panda',      zh: '熊猫',   sound: '/p/',  color: 'slate',   icon: 'panda' },
  { upper: 'Q', lower: 'q', name: 'Q', example: 'queen',      zh: '女王',   sound: '/kw/', color: 'pink',    icon: 'queen' },
  { upper: 'R', lower: 'r', name: 'R', example: 'rabbit',     zh: '兔子',   sound: '/r/',  color: 'rose',    icon: 'rabbit' },
  { upper: 'S', lower: 's', name: 'S', example: 'sun',        zh: '太阳',   sound: '/s/',  color: 'yellow',  icon: 'sun' },
  { upper: 'T', lower: 't', name: 'T', example: 'tree',       zh: '大树',   sound: '/t/',  color: 'green',   icon: 'tree' },
  { upper: 'U', lower: 'u', name: 'U', example: 'umbrella',   zh: '雨伞',   sound: '/ʌ/',  color: 'violet',  icon: 'umbrella' },
  { upper: 'V', lower: 'v', name: 'V', example: 'van',        zh: '货车',   sound: '/v/',  color: 'red',     icon: 'van' },
  { upper: 'W', lower: 'w', name: 'W', example: 'watermelon', zh: '西瓜',   sound: '/w/',  color: 'emerald', icon: 'watermelon' },
  { upper: 'X', lower: 'x', name: 'X', example: 'xylophone',  zh: '木琴',   sound: '/eks/', color: 'emerald', icon: 'xylophone' },
  { upper: 'Y', lower: 'y', name: 'Y', example: 'yo-yo',      zh: '悠悠球', sound: '/j/',  color: 'amber',   icon: 'yoyo' },
  { upper: 'Z', lower: 'z', name: 'Z', example: 'zebra',      zh: '斑马',   sound: '/z/',  color: 'slate',   icon: 'zebra' },
]
